...
if ($cookiePageSubmit.length > 0) {
  ...
  if (
    typeof consents["google-analytics"] !== "undefined" ||
    typeof consents["hotjar"] !== "undefined"
  ) {
    var preselected =
      Boolean(consents["google-analytics"]) || Boolean(consents["hotjar"]);
  ...
  $("#main-content > div")
    .first()
    .wrap('<form id="cookie-page-form" novalidate></form>');
